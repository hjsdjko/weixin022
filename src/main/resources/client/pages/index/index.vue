	...
	<view :style='{"width":"100%","flexWrap":"wrap","background":"#ffffff","display":"flex","height":"100%"}'>
		...
		<!-- 商品列表 -->
			...
			<view class="title" :style='{"width":"calc(100% - 48rpx)","padding":"20rpx 80rpx","margin":"0 24rpx 24rpx 24rpx","textAlign":"center","background":"url(http://clfile.zggen.cn/20231130/99a276c461c94b9a9ab19652b1976f71.png) no-repeat center top / 100% 100%","height":"auto"}'>
				<view :style='{"padding":"12rpx 60rpx 8rpx 120rpx","color":"#333","borderRadius":"8rpx","background":"none","display":"inline-block","fontSize":"32rpx","lineHeight":"48rpx","minWidth":"300rpx","fontWeight":"500"}'>心理教师</view>
				<text :style='{"margin":"10rpx 0 0 0","color":"#666","display":"inline-block","width":"auto","fontSize":"28rpx","lineHeight":"48rpx","float":"right"}' @tap="onPageTap('xinlijiaoshi')">查看更多</text>
			</view>
		  ...
		  <view class="list-box style1" :style='{"padding":"24rpx 24rpx 24rpx 24rpx","margin":"0 0 0 0","flexWrap":"wrap","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
			<view @tap="onDetailTap('xinlijiaoshi',product.id)" v-for="(product,index) in homexinlijiaoshilist" :key="index" class="list-item" :style='{"border":"0px solid #3da74250","boxShadow":"0 0px 0px #cccccc","padding":"20rpx","margin":"0 0 40rpx 0","backgroundColor":"#ffffff","borderRadius":"8rpx","textAlign":"center","flexWrap":"wrap","display":"flex","width":"48%","justifyContent":"center","height":"auto"}'>
			                			  			  			                			  			  			                			  <view :style='{"border":"2rpx solid #eeeeee","padding":"0px 20rpx 0px 20rpx","margin":"0 0 12rpx 0","whiteSpace":"nowrap","color":"#333333","overflow":"hidden","borderRadius":"0px","background":"#fff00010","width":"100%","fontSize":"28rpx","lineHeight":"48rpx","textOverflow":"ellipsis","height":"48rpx","order":"2"}' class="list-item-title ">教师姓名:{{product.jiaoshixingming}}</view>
			  			  			  			                			  			  <image :style='{"padding":"0 0 0 0","margin":"0 0 20rpx 0","objectFit":"cover","borderRadius":"0px","display":"inline-block","width":"100%","height":"200rpx"}' class="list-item-image" mode="aspectFill" v-if="product.zhaopian.substring(0,4)=='http'" :src="product.zhaopian"></image>
			  <image :style='{"padding":"0 0 0 0","margin":"0 0 20rpx 0","objectFit":"cover","borderRadius":"0px","display":"inline-block","width":"100%","height":"200rpx"}' class="list-item-image" mode="aspectFill" v-else :src="product.zhaopian?baseUrl+product.zhaopian.split(',')[0]:''"></image>
			  			  			                			  			  			                			  			  			                			  <view :style='{"border":"2rpx solid #eeeeee","padding":"0px 20rpx 0px 20rpx","margin":"0 0 12rpx 0","whiteSpace":"nowrap","color":"#333333","overflow":"hidden","borderRadius":"0px","background":"#fff00010","width":"100%","fontSize":"28rpx","lineHeight":"48rpx","textOverflow":"ellipsis","height":"48rpx","order":"2"}' class="list-item-title ">专业资质:{{product.zhuanyezizhi}}</view>
			  			  			  			                			  			  			                			  			  			                			  			  			                			  			  			  			</view>
		  </view>
		...
		<!-- 新闻资讯 -->
			...
			<view class="title" :style='{"width":"calc(100% - 48rpx)","padding":"20rpx 80rpx","margin":"0 24rpx 24rpx 24rpx","textAlign":"center","background":"url(http://clfile.zggen.cn/20231130/99a276c461c94b9a9ab19652b1976f71.png) no-repeat center top / 100% 100%","height":"auto"}'>
				<view :style='{"padding":"8rpx 60rpx 8rpx 120rpx","color":"#333","borderRadius":"8rpx","background":"none","display":"inline-block","fontSize":"32rpx","lineHeight":"48rpx","minWidth":"300rpx","fontWeight":"500"}'>心理知识</view>
...
<script>
	...
	export default {
		...
		async onShow() {
			...
			res = await this.$api.list('xinlijiaoshi', {
				page: 1,

				limit: 4
			});
			this.homexinlijiaoshilist = res.data.list
		},
