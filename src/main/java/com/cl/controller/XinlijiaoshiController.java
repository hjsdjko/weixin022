...
public class XinlijiaoshiController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		XinlijiaoshiEntity u = xinlijiaoshiService.selectOne(new EntityWrapper<XinlijiaoshiEntity>().eq("jiaoshigonghao", username));
        if(u==null || !u.getMima().equals(password)) {
            return R.error("账号或密码不正确");
        }
		String token = tokenService.generateToken(u.getId(), username,"xinlijiaoshi",  "管理员" );
    ...
    public R register(@RequestBody XinlijiaoshiEntity xinlijiaoshi){
    	...
    	XinlijiaoshiEntity u = xinlijiaoshiService.selectOne(new EntityWrapper<XinlijiaoshiEntity>().eq("jiaoshigonghao", xinlijiaoshi.getJiaoshigonghao()));
		if(u!=null) {
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        XinlijiaoshiEntity u = xinlijiaoshiService.selectById(id);
    ...
    public R resetPass(String username, HttpServletRequest request){
        ...
        u.setMima("123456");
        xinlijiaoshiService.updateById(u);
